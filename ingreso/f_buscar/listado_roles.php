...
if ($resultado && $resultado->num_rows > 0) {
    while ($fila = $resultado->fetch_assoc()) {
        ...
        $salida .= "<tr>
                        <td class='center'>
                            <a class='btn btn-info product1' codigo1='".htmlspecialchars($fila['id_rol'])."' data-toggle='modal' data-target='#Ingreso1'>
                                <i class='fa fa-edit'></i>
                            </a>
                        </td>
                        <!--<td class='center'>
                            <a class='btn btn-info product2' codigo2='".htmlspecialchars($fila['id_rol'])."' codigo3='".htmlspecialchars($fila['id_cliente'])."' onclick='openForm()'>
