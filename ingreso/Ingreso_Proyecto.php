...
<html lang="en">
  ...
  <body>
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li>
          <a href="Ingreso_Proyecto.php"><span class="fa fa-tasks"></span> Ingreso Proyecto</a>
          </li>
        </ul>
