...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Listado Proveedores</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="productos" width="100%" cellspacing="0">
                  <thead>
                    <?php include '../f_buscar/bus_proveedor.php'; ?>
                  </tbody>
                </table>
              </div>
            </div>
  ...
  <div class="modal fade" id="Ingreso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Estas seguro de Editar Proveedor?.
  ...
  <script type="text/javascript">
   ...
   function sendDataProduct(){
     ...
     $.ajax({
      url:'../f_update/edit_proveedor.php',
      type: 'POST',
      async:true,
