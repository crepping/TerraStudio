        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Ingreso Cliente</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="productos" width="100%" cellspacing="0">
                  <thead>
                    <?php 
                    include '../f_buscar/bus_ingreso_reserva.php'; 
                    ?>
                  </tbody>
                </table>
              </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0 prueba">
                  <!--
                ...
                <div class="form-group row">
                 ...
                 <p class="estado"></p>
                <!-- <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0 codigo">
                    <input type="hidden" class="form-control form-control-user codigo" id="exampleInputPassword" name="precio" placeholder="Precio" required>
                  </div>
                </div> -->
