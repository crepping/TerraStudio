...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Listado Vehiculos</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="productos" width="100%" cellspacing="0">
                  <thead>
                    <?php include '../f_buscar/buscar_car.php'; ?>
                  </tbody>
                </table>
              </div>
            </div>
  ...
  <div class="modal fade" id="Ingreso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Estas seguro de Editar el Vehiculo?.
        ...
        <div class="formulario">
                ...
                <hr>
                 ...
                 <button class="btn btn-primary" id="ingresar" type="submit">Modificar Proveedor</button>
        </form>
        <HR>
        <BR>
        <BR>
  ...
  <div class="modal fade" id="Ingreso1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Estas seguro de Borrar el Proveedor?.
        <form method="post" id="reserva1"  onsubmit="event.preventDefault(); sendDataProduct1();">
        <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="codigo1" name="borrar">
        </div>
                 <BR>
                 <BR>
                 <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                 <button class="btn btn-primary" id="ingresar1" type="submit">Borrar Proveedor</button>
        </form>
        <HR>
        <BR>
        <BR>
  ...
  <script type="text/javascript">
   $('.product').click(function(event){
    ...
    var codigo = $(this).attr('codigo1');
    var action = 'infoProducto';
    $.ajax({
      url:'../f_buscar/bus_vehiculo.php',
      type: 'POST',
      async:true,
   ...
   function sendDataProduct(){
     ...
     $.ajax({
      url:'../f_update/edit_vehiculo.php',
      type: 'POST',
      async:true,
  ...
  <script type="text/javascript">
   $('.product1').click(function(event){
    ...
    $.ajax({
      url:'../f_buscar/buscar_proveedor.php',
      type: 'POST',
      async:true,
   ...
   function sendDataProduct1(){
     $('.alertAddProduct').html('');
     $.ajax({
      url:'../f_update/borrar_proveedor.php',
      type: 'POST',
      async:true,
